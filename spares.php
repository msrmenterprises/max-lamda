                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div class="single-service-item">
                                ...
                                <div class="service-title">
                                    <h4><a class="cust_h4" href="lm2500.html">LM2500 Turbine Generator Spares</a></h4>
                                </div>                        
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                            <div class="single-service-item">
                                ...
                                <div class="service-title">
                                    <h4><a class="cust_h4" href="marine_diesel.html">Marine Diesel Engine Spares</a></h4>
                                </div>
            ...
            <div class="row mt-60">
                <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="single-service-item">
                        ...
                        <div class="service-title">
                            <h4><a class="cust_h4" href="heat_exchanger.html">Heat Exchanger Spares</a></h4>
                        </div>                        
                    </div>
                </div>
