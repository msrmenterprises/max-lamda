...
<div id="home-2" class="homepage-slides owl-carousel">
    <div class="single-slide-item">
        <div class="image-layer" style="background-image: url(images/banner03.jpg);">
            <!-- <div class="overlay"></div> -->
        </div>        
...
Excellence
    ...
    <div class="single-slide-item">
        <div class="image-layer" style="background-image: url(images/banner01.jpg);">
            <!-- <div class="overlay"></div> -->
        </div>
        <div class="hero-area-content">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <!-- <div class="company-email">
                            <a href="info@Max Lambda.net">info@Max Lambda.net</a> | <a href="info@Max Lambda.com">info@Max Lambda.com</a>
