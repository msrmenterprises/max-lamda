                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div class="single-service-item">
                                ...
                                <div class="service-title">
                                    <h4><a class="cust_h4" href="valves.html">Valves</a></h4>
                                </div>                        
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                            <div class="single-service-item">
                                ...
                                <div class="service-title">
                                    <h4><a class="cust_h4" href="pumps.html">Pumps</a></h4>
                                </div>
            ...
            <div class="row mt-60">
                <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="single-service-item">
                        ...
                        <div class="service-title">
                            <h4><a class="cust_h4" href="compressors.html">Compressors</a></h4>
                        </div>                        
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="single-service-item">
                        ...
                        <div class="service-title">
                            <h4><a class="cust_h4" href="hvac.html">HVAC Systems</a></h4>
                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="single-service-item">
                        ...
                        <div class="service-title">
                            <h4><a class="cust_h4" href="pipes_fitting.html">Pipes & Fittings</a></h4>
                        </div>
            ...
            <div class="footer-up">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <p>info@max-lambda.com | info@max-lambda.com</p>
